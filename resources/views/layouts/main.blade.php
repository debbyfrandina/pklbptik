	...
	<div class="wrapper">
		...
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
              ...
              <i class="align-middle " data-feather="file-plus"></i> <span class="align-middle">Form Data</span>
            </a>
					</li>

					<li class="sidebar-item {{ ($title === "data" ) ? 'active' : '' }}">
						<a class="sidebar-link" href="/data">
              <i class="align-middle" data-feather="file"></i> <span class="align-middle">Data (SIE)</span>
            </a>
					</li>
